...
@MotorType(ticksPerRev = 753.2, gearing = 26.9, maxRPM = 223, orientation = Rotation.CCW, achieveableMaxRPMFraction = 1.0)
@DeviceProperties(xmlTag = "goBilda223", name = "GoBILDA 223", builtIn = false)
