...
@MotorType(ticksPerRev = 1425.2, gearing = 50.9, maxRPM = 117, orientation = Rotation.CCW, achieveableMaxRPMFraction = 1.0)
@DeviceProperties(xmlTag = "goBilda117", name = "GoBILDA 117", builtIn = false)
