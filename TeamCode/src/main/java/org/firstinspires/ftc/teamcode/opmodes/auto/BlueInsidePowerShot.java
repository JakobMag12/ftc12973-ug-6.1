...
@Autonomous(name="Blue Power", group="Blue")
//@Disabled
public class BlueInsidePowerShot extends RobotOpModes {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        bot.trigger.fire();
        pause(0.5);
        new AutoComGyroTurn(this, 0.5, -5.0);
        bot.trigger.fire();
        pause(0.5);
        new AutoComGyroTurn(this, 0.5, -10.0);
        bot.trigger.fire();
        pause(0.5);
        new AutoComGyroTurn(this, 0.5, 12.0);
