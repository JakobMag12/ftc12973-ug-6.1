...
@MotorType(ticksPerRev = 38.6, gearing = 13.7, maxRPM = 435, orientation = Rotation.CCW, achieveableMaxRPMFraction = 1.0)
@DeviceProperties(xmlTag = "goBilda435", name = "GoBILDA 435", builtIn = false)
